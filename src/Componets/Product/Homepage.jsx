...
function Homepage() {
    ...
    return (
        <div>
            ...
            <div>
                <div className="Playstore-Section text-white">
                    <h1 className="text-3xl md:text-5xl font-bold mb-4 text-white text-center download-app">
                        Download Our App
                    </h1>
                    <p className="text-lg md:text-xl text-white text-center mb-4 download-p">
                    ...
                    <div className='imge-container'><img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/3b76bbd13b-6dc142c668ab93b7dd2d.png" alt="" /></div>
